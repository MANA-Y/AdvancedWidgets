...
class _LayoutPageState extends State<LayoutPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sizes и Constraints'),
      ),
      body: Column(
...
class Example25 extends Example {
  ...
  final String explanation =
      ...
      "\n\n"
      "Instead, it will define the Expanded width according to the other children, and only then the Expanded widget will force the original child to have the expanded width."
      "\n\n"
